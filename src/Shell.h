...
class Shell {
 public:
  ...
  using callFunction_t = std::function<void(
      argv_t, Shell)>;  // llamado de una funcion por un comando
 ...
 private:
  ...
  /*----Constructor----*/
 public:
  Shell(std::string command, callFunction_t myFunction,
        std::string commandUsage, std::string commandDescription, int argc);
  ...
  class SyntaxError : public std::exception {
   ...
   private:
    ...
    /*----Constructor----*/
   public:
    SyntaxError(TypeError typeError,
