...
std::vector<Shell> commands = {
    Shell("cargar", Controller::Cargar, "cargar <nombre_archivo>",
          "carga el archivo especifico", 2),
    Shell("conteo", Controller::conteo, "conteo",
          "Imprime la cantidad de secuencias", 1),
    Shell("listar_secuencias", Controller::listar_secuencias,
          "listar_secuencias", "Imprime la informacion de cada secuencia", 1),
    Shell("histograma", Controller::histograma,
          "histograma <descripcion_secuencia>",
          "Imprime el histograma de una secuencia", 2),
    Shell("es_subsecuencia", Controller::es_subsecuencia,
          "es_subsecuencia <secuencia>",
          "Determina si una secuencia existe dentro de las secuencias cargadas",
          2),
    Shell("enmascarar", Controller::enmascarar, "enmascarar <secuencia>",
          "Enmascara una secuencia determinada con el codigo X", 2),
    Shell("guardar", Controller::guardar, "guardar <nombre_archivo>",
          "Guarda en el <nombre_archivo> las secuencias", 2),
    Shell("codificar", Controller::codificar, "codificar nombre_archivo.fabin",
          "El comando debe generar el archivo binario con la correspondiente "
          "codificacion de Huffman",
          2),
    Shell("decodificar", Controller::decodificar,
          "decodificar nombre_archivo.fabin",
          "El comando debe cargar en memoria las secuencias contenidas en el "
